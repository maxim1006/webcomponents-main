...
const MFetch = class {
    ...
    render() {
        ...
        const familyTable = this.familyData ? h("table", null, familyTableHead, familyTableBody) : null;
        const loader = this.loading ? h("m-spinner", null) : null;
        return [
            h("form", { novalidate: true, onSubmit: this.fetchFamilyData, name: 'fetchForm' }, h("select", { id: 'select', ref: el => this.selectElement = el }, options), h("button", { type: "submit" }, "get info")),
