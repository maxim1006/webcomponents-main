...
class ShadowTooltip extends HTMLElement {
  // для логики
  constructor() {
    super(); // задаю смогу ли достучаться до шадоу дома снаружи, если нет, то "close"
    // this.shadowRoot - появляется сразу как аттачу шадоу

    _defineProperty(this, "_tooltipText", "Init tooltip text");

    _defineProperty(this, "newSpan", void 0);

    _defineProperty(this, "tooltip", void 0);

    _defineProperty(this, "tooltipVisible", false);
  ...
  connectedCallback() {
    ...
    this._createTooltip(); // аттачу темплейт который взял извне компоненты
